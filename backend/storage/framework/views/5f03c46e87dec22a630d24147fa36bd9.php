...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/style.css')); ?>"> <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <style>
        :root {
...
<body class="login-container">
    <div class="login-card">
        ...
        <form method="POST" action="<?php echo e(url('/login')); ?>" id="login-form">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="redirect" value="<?php echo e($redirect ?? session('intended_url', '/')); ?>">
        ...
        <div class="signup-link">
            <a href="<?php echo e(url('/signup')); ?>" class="btn btn-secondary">Create an account</a>
        </div>
    </div>

    <script src="<?php echo e(asset('js/main.js')); ?>"></script>
</body>
</html><?php /**PATH C:\Users\ASUS\Documents\GitHub\nandana-tea-factory-website-HMMC_2\nandana-tea-factory-website-HMMC_2\backend\resources\views/user-login.blade.php ENDPATH**/ ?>