...
<body>
    <header>
        ...
        <div class="header-icons">
            <?php if(session()->has('user_signup_id')): ?>
                <a href="<?php echo e(url('/profile')); ?>" title="My Profile"><i class="fa-solid fa-user"></i></a>
        ...
        <div class="profile-card">
            <div class="profile-header">
                ...
                <div class="profile-actions">
                    <a href="<?php echo e(url('/edit-profile')); ?>" class="btn-edit">
            ...
            <?php if(session()->has('user_signup_id') && $user): ?>
            <div class="profile-grid">
                <div class="profile-info">
                    ...
                    <div class="info-group">
                        ...
                        <div class="info-value"><?php echo e($user->address ?? 'Not provided'); ?></div>
                    </div>
                </div>
                <div class="avatar">
                    <img src="srs/avatar-placeholder.png" alt="avatar">
                    <h3 style="margin-top:0.75rem;"><?php echo e($user->name); ?></h3>
                    <p style="color:var(--text-medium); margin: 0;"><?php echo e($user->email); ?></p>
                </div>
            </div>
            <?php else: ?>
            <div style="text-align: center; padding: 2rem;">
                <p>Please <a href="<?php echo e(url('/login')); ?>" style="color: var(--primary-green); text-decoration: none; font-weight: 600;">login</a> to view your profile.</p>
            </div>
            <?php endif; ?>
        </div>
    </main>
...
<?php /**PATH C:\Users\ASUS\Documents\GitHub\nandana-tea-factory-website-HMMC_2\nandana-tea-factory-website-HMMC_2\backend\resources\views/profile.blade.php ENDPATH**/ ?>