    ...
    <header>
       ...
       <nav>
        ...
        <div class="header-icons" style="display:flex;align-items:center;gap:12px;">
            <?php if(!$currentUser): ?>
                <a href="<?php echo e(url('/products')); ?>"><i class="fa-solid fa-shopping-cart"></i> Cart</a>
            <?php endif; ?>
            <?php if($currentUser): ?>
            ...
            <div class="cart-wrapper">
                <div class="cart-items-section">
                    ...
                    <div id="cart-empty" class="empty-cart-state">
                        ...
                        <a href="<?php echo e(url('/products')); ?>" class="continue-shopping">
...
</html><?php /**PATH C:\Users\ASUS\Documents\GitHub\nandana-tea-factory-website-HMMC_2\nandana-tea-factory-website-HMMC_2\backend\resources\views/cart.blade.php ENDPATH**/ ?>