    ...
    <main class="container">
        ...
        <section id="login-section" class="wholesale-grid">
            ...
            <div style="padding-top: 3rem;">
                ...
                <a href="<?php echo e(url('/wholesale-signup')); ?>" class="btn btn-primary">Create an Account</a>
            </div>
        </section>
        ...
        <section id="wholesale-products-section" style="display:none; margin-top: 2rem;">
            ...
            <div class="product-controls">
                ...
                <a href="<?php echo e(url('/products')); ?>" class="btn">Retail</a>
            </div>
        ...
        <section class="form-container" style="margin-top: 4rem; max-width: none;">
            ...
            <?php endif; ?>
            <form id="wholesale-inquiry-form" method="POST" action="<?php echo e(url('/wholesale/inquiry')); ?>" novalidate>
                <?php echo csrf_field(); ?>
                <div class="form-group">
        ...
        function renderWholesaleProducts(products) {
            ...
            grid.innerHTML = products.map(p => `
                <div class="product-card">
                    ...
                    <a href="<?php echo e(url('/wholesale-product')); ?>?id=${encodeURIComponent(p.slug)}">View More</a>
                </div>
            `).join('');
        }
...
<?php /**PATH C:\Users\ASUS\Documents\GitHub\nandana-tea-factory-website-HMMC_2\nandana-tea-factory-website-HMMC_2\backend\resources\views/wholesale.blade.php ENDPATH**/ ?>