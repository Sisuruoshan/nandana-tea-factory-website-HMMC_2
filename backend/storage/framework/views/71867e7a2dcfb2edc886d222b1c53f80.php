        ...
        <div class="edit-profile-container">
            ...
            <div class="access-denied-container">
                <div class="access-denied-card">
                    ...
                    <a href="<?php echo e(url('/login')); ?>" class="btn-login">
                ...
                <div class="profile-header-section">
                    <div class="profile-avatar-container">
                        <img id="avatar-preview" class="profile-avatar" 
                             src="<?php if($user && $user->avatar): ?><?php echo e(asset('storage/' . $user->avatar)); ?><?php else: ?><?php echo e(asset('images/default-avatar.png')); ?><?php endif; ?>" 
                             alt="Profile Avatar" 
                    ...
                    <div class="profile-header-info">
                        <h2 id="profile-name-display"><?php echo e($user->name ?? 'Your Name'); ?></h2>
                        <p id="profile-email-display"><?php echo e($user->email ?? 'your.email@example.com'); ?></p>
...
<?php /**PATH C:\Users\ASUS\Documents\GitHub\nandana-tea-factory-website-HMMC_2\nandana-tea-factory-website-HMMC_2\backend\resources\views/edit-profile.blade.php ENDPATH**/ ?>