...
<body>
    ...
    <div class="header-icons" style="display:flex;align-items:center;gap:12px;">
        ...
        <?php if($currentUser): ?>
            <a href="<?php echo e(url('/cart')); ?>" class="cart-icon" style="margin-right: 12px;">
    ...
    <main class="container">
        ...
        <div class="product-controls">
            ...
            <a href="<?php echo e(url('/wholesale')); ?>" class="btn">Wholesale</a>
        </div>
        ...
        function renderProducts(products) {
            ...
            grid.innerHTML = products.map(p => `
                <div class="product-card" data-name="${(p.name || '').toLowerCase()}" data-desc="${(p.description || '').toLowerCase()}">
                    ...
                    <a href="<?php echo e(url('/product')); ?>?id=${encodeURIComponent(p.slug)}">View More</a>
                </div>
            `).join('');
        }
...
</html><?php /**PATH C:\Users\ASUS\Documents\GitHub\nandana-tea-factory-website-HMMC_2\nandana-tea-factory-website-HMMC_2\backend\resources\views/products.blade.php ENDPATH**/ ?>